...
function byvex_woocommerce_starter_wrapper_start()
{
    echo '<section class="container py-4">';
}
add_action('woocommerce_before_main_content', 'byvex_woocommerce_starter_wrapper_start', 10);
function byvex_woocommerce_starter_wrapper_end()
{
    echo '</section>';
}
add_action('woocommerce_after_main_content', 'byvex_woocommerce_starter_wrapper_end', 10);
