...
if (!class_exists('Bootstrap_Walker_Nav_Menu')) :
	...
	class Bootstrap_Walker_Nav_Menu extends Walker_Nav_Menu
	{
		...
		public static function fallback($args)
		{
			...
			$fallback_output .= '<li class="nav-item"><a href="' . esc_url(admin_url('nav-menus.php')) . '" class="nav-link" title="' . esc_attr__('Add a menu', 'byvex-woocommerce-starter') . '">' . esc_html__('Add a menu', 'byvex-woocommerce-starter') . '</a></li>';
			$fallback_output .= '</ul>';
