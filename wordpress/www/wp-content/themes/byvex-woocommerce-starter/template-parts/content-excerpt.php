	...
	<div class="card h-100 shadow-sm">
		...
		<div class="card-body">
			<small class="d-block text-truncate">
				<?php byvex_woocommerce_starter_posted_on(); ?> by
				<?php byvex_woocommerce_starter_posted_by(); ?>
			</small>
			<a href="<?php esc_url(the_permalink()); ?>" class="text-decoration-none text-body">
				<div class="card-title h5 mb-0"><?php the_title(); ?></div>
				<?php the_excerpt(); ?>
			</a>
			<?php
			byvex_woocommerce_starter_entry_footer();
			?>
		</div>
	</div>
</article>
