...
class Media_Library_Organizer_Media {
	...
	public function enqueue_js_css() {
		...
		// CSS.
		wp_enqueue_style( $this->base->plugin->name . '-media', $this->base->plugin->url . 'assets/css/media.css', false, $this->base->plugin->version );
	...
	public function register_selectize_js_css( $ext ) {
		...
		// CSS: Register.
		wp_register_style( 'wpzinc-admin-selectize', $this->base->dashboard->dashboard_url . 'css/selectize.css', false, $this->base->plugin->version );
