...
<p class="vimeo-settings__paragraph vimeo-settings__text-box">
	<?php esc_html_e( 'Head over to Vimeo to get your activation key. You’ll need this to connect your account to WordPress. Don’t have a Vimeo account?', 'vimeo-for-wordpress' ); ?>
...
<p>
	<a class="vimeo-settings__link" href="<?php echo esc_url( $request->get_connect_url() ); ?>" target="_blank" >
		<span class="link-text"> <?php esc_html_e( 'Get an activation key', 'vimeo-for-wordpress' ); ?> </span>
...
<p class="vimeo-settings__paragraph vimeo-settings__text-box">
	<?php esc_html_e( 'Using the activation key you recieved on Vimeo.com, copy and paste it below to connect your account.', 'vimeo-for-wordpress' ); ?>
</p>
