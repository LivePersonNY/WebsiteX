            ...
            <div class="p-4 shadow-cstm bg-white rounded">
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo add_query_arg(array('tab' => 'licensing'), htmlentities($_SERVER['REQUEST_URI'])); ?>"><input type="button" class="btn btn-cstm" value="<?php _e('Check Licensing Plans', 'miniorange-saml-20-single-sign-on'); ?>" /></a>
                        </td>
                    </tr>
                </table>
            ...
            <div class="row justify-content-center">
                <div class="col-md-6 mt-5">
                    ...
                    <div class="text-center">
                        <img src="<?php echo plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . '/images/mo-saml-registration-form-bg.webp' ?>" width="46%" alt="wordpress saml registration form">
                    </div>
                </div>
