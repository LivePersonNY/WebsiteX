...
function mo_saml_apps_config_saml()
{
    ...
    if (!empty($mo_saml_identity_provider_identifier_name)) {
        if (array_key_exists($mo_saml_identity_provider_identifier_name, mo_saml_options_plugin_idp_specific_ads::$idp_specific_ads)) {
        ...
        if (array_key_exists($mo_saml_identity_provider_identifier_name, mo_saml_options_plugin_idp::$IDP_GUIDES)) {
            ...
            $idp_data->image_src = plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . 'images/idp-guides-logos/' . $idp_key . '.png';
            if ($idp_key == array_key_exists($idp_key, mo_saml_options_plugin_idp_videos::$IDP_VIDEOS)) {
...
?>
    <div class="row container-fluid" id="cstm-idp-section">
        <div class="col-md-8 mt-4 ml-5">
            <?php mo_saml_display_idp_selector();
            mo_saml_display_sp_configuration($saml_identity_name, $saml_login_url, $saml_issuer, $saml_x509_certificate, $mo_saml_identity_provider_identifier_name, $saml_is_encoding_enabled, $idp_data);
            ?>
...
?>
    ...
    <input type="hidden" name="idp_specific_ads" id="idp_specific_ads" value='<?php echo json_encode(mo_saml_options_plugin_idp_specific_ads::$idp_specific_ads) ?>' />
<?php
}

function mo_saml_display_sp_configuration($saml_identity_name, $saml_login_url, $saml_issuer, $saml_x509_certificate, $mo_saml_identity_provider_identifier_name, $saml_is_encoding_enabled, $idp_data)
{
?>
    <div class="p-4 shadow-cstm bg-white rounded mt-4" id="idp_scroll_saml">
        ...
        <div class="mo-saml-sp-tab-container mt-4">
            ...
            <div class="mo-saml-sp-tab">
                <input type="hidden" id="mo-saml-test-window-url" value="<?php echo mo_saml_get_test_url(); ?>">
                <input type="hidden" id="mo-saml-attribute-mapping-url" value="<?php echo mo_saml_get_attribute_mapping_url(); ?>">
                <input type="hidden" id="mo-saml-service-provider-url" value="<?php echo mo_saml_get_service_provider_url(); ?>">
                <input type="hidden" id="mo-saml-redirect-sso-url" value="<?php echo mo_saml_get_redirection_sso_url(); ?>">
                    ...
                    <div id="mo-saml-idp-manual-tab" class="mo-saml-tab-content">
                        ...
                        <div class="row align-items-top mt-2">
                            ...
                            <div class="col-md-9">
                                ...
                                <input type="button" class="btn btn-cstm rounded mt-3 w-176" id="test_config" <?php if (!mo_saml_is_sp_configured() || !get_option('saml_x509_certificate') || !mo_saml_is_openssl_installed())
                        ...
                        <div class="row align-items-top mt-2">
                            <div class="col-md-3"></div>
                            <div class="col-md-9">
                                <input type="button" class="btn btn-cstm rounded mt-3 w-372" name="saml_request" id="export-import-config" <?php if (!mo_saml_is_sp_configured() || !get_option('saml_x509_certificate')) {
                                                                                                                                                echo 'disabled';
                ...
                <div id="mo-saml-upload-idp-tab" class="mo-saml-tab-content">
                    <form name="saml_upload_metadata_form" method="post" id="saml_upload_metadata_form" action="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=save'); ?>" enctype="multipart/form-data">
