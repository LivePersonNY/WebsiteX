...
?>
    <div class="p-4 shadow-cstm bg-white rounded">
        ...
        <div class="row prem-info mt-5 d-block">
            <div class="prem-icn nameid-prem-img"><img src="<?php echo plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . 'images/crown.png' ?>" width="35px">
                <p class="nameid-prem-text">These attributes are configurable in Standard, Premium, Enterprise and All-Inclusive versions of the plugin. <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing'); ?>" class="text-warning">Click here to upgrade</a></p>
            </div>
            <div class="row align-items-top">
                <div class="col-md-3">
        ...
        <div class="row align-items-top mt-5 prem-info">
            <div class="prem-icn anonymous-prem-img"><img src="<?php echo plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . 'images/crown.png' ?>" width="35px">
                <p class="anonymous-text">Enable this option if you want to allow users to login to the WordPress site without creating a WordPress user account for them. <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing'); ?>" class="text-warning">Available in Paid Plugin</a></p>
            </div>
            <div class="col-md-3">
    ...
    <form name="saml_form_am_role_mapping" method="post" action="">
        ...
        <div class="p-4 shadow-cstm bg-white rounded mt-4">
            ...
            <div class="row prem-info mt-5">
                <div class="prem-icn role-prem-img"><img src="<?php echo plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . 'images/crown.png' ?>" width="35px">
                    <p class="role-prem-text">Customized Role Mapping options are configurable in the Premium, Enterprise and All-Inclusive versions of the plugin. <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing'); ?>" class="text-warning">Click here to upgrade</a></p>
                </div>
            ...
            <div class="row d-block prem-info mt-5">
                <div class="prem-icn role-admin-prem-img"><img src="<?php echo plugin_dir_url(mo_saml_options_plugin_constants::PLUGIN_FILE) . 'images/crown.png' ?>" width="35px">
                    <p class="role-admin-prem-text">Customized Role Mapping options are configurable in the Premium, Enterprise and All-Inclusive versions of the plugin. <a href="<?php echo admin_url('admin.php?page=mo_saml_settings&tab=licensing'); ?>" class="text-warning">Click here to upgrade</a></p>
                </div>
                <?php
...
function mo_saml_display_attrs_list()
{
    ...
    if (!empty($idp_attrs)) { ?>
        <div class="bg-white text-center shadow-cstm rounded contact-form-cstm p-4">
            <h4><?php _e('Attributes sent by the Identity Provider', 'miniorange-saml-20-single-sign-on'); ?>:</h4>
            <div>
                <table style="table-layout: fixed;border: 1px solid #fff;width: 100%;background-color: #e9f0ff;">
                    <tr style="text-align:center;background:#d3e1ff;">
                        <td style="font-weight:bold;padding: 2%;word-break: break-word;border:2.5px solid #fff;"><?php _e('ATTRIBUTE NAME', 'miniorange-saml-20-single-sign-on'); ?></td>
                        <td style="font-weight:bold;padding: 2%;word-break: break-word;border:2.5px solid #fff;"><?php _e('ATTRIBUTE VALUE', 'miniorange-saml-20-single-sign-on'); ?></td>
                    </tr>
                ...
                <br />
                <p style="text-align:center;"><input type="button" class="btn-cstm rounded mt-3" value="<?php _e('Clear Attributes List', 'miniorange-saml-20-single-sign-on'); ?>" onclick="document.forms['attrs_list_form'].submit();"></p>
