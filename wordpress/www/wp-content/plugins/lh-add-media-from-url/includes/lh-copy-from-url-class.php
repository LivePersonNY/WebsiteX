...
$sql = "SELECT 	posts.ID, meta.meta_id, meta.meta_value FROM ".$wpdb->posts." posts, ".$wpdb->postmeta." meta WHERE posts.post_type = 'attachment' and posts.ID = meta.post_id and meta.meta_key = '_lh_copy_from_url-original_file' and meta.meta_value = '".$url."' LIMIT 1";
...
return $fileextension;
	...
	** download_url
clones the wordpress native method but with a spoofed user-agent
	*/
