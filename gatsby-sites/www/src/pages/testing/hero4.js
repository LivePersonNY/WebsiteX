...
// CSS infinite animation, column images, opposite directions
...
const Hero4 = () => {
  ...
  return (
    <Layout mainClass="hp-2023">
      <Seo title="Hero4 | LivePerson" description="" robots="noindex, nofollow" />
                ...
                <div className="col-lg-6 offset-lg-1">
                    ...
                    <div className="infinite-slider">
                        <div className="slide-track">
                            <div className="slide">
                                <img src="https://lp-site.s3.amazonaws.com/web2023/img/Avatars-Left.png" />
                            </div>
                            <div className="slide">
                                <img src="https://lp-site.s3.amazonaws.com/web2023/img/Avatars-Left.png" />
                            </div>
                    ...
                    <div className="infinite-slider infinite-slider-reverse">
                        <div className="slide-track">
                            <div className="slide">
                                <img src="https://lp-site.s3.amazonaws.com/web2023/img/UI-Right.png" />
                            </div>
                            <div className="slide">
                                <img src="https://lp-site.s3.amazonaws.com/web2023/img/UI-Right.png" />
                            </div>
