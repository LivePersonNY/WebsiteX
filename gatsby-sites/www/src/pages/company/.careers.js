...
const CareersPage = () => {
    ...
    return (
      ...
      <script src={withPrefix('scripts/careers.js')} type="text/javascript" data-type="pageScript" />
            ...
            <Seo
                meta={meta}
                title="Careers - Become a LivePerson AI Native"
                description="Are you interested in working at LivePerson? Browse through our list of available career opportunities around the globe or contact us for assistance."
            />
                ...
                <div className="container">
                    <div className="row align-items-center justify-content-center">
                        <div className="col-lg-8">
                            ...
                            <p>
                                Our Conversational Cloud platform empowers
                                millions of people by allowing them to directly
                                message their favorite brands. Join our team and
                                be a part of the world’s next digital evolution.
                            </p>
                            <form
                            ...
                            >
                                ...
                                <a
                                    ...
                                    href="https://careers.liveperson.com?source=campaignA&amp;gh_src="
                                    target="_blank"
                            ...
                            <a
                                href="https://careers.liveperson.com/upload/?source=CampaignA&amp;gh_src="
                                className="btn btn-primary resume-upload"
                            >
                                <img
                                    src="https://static.liveperson.com/static-assets/2022/02/08142543/upload_Vector.svg"
                                    alt="Upload icon"
            ...
            <div className="pane comp-icon-text-d bg-primary-light pane-with-lead-text">
                <div className="container">
                    <div className="row">
                        <div className="col-lg-8 offset-lg-2 text-center">
                            <h2 className="">Fastest growing teams</h2>
                            <p></p>
                        </div>
                    </div>
                    <div className="row row-cols-lg-3 row-cols-1 comp-block-grid-container ">
                        <div className="col">
                            <div className="comp-body-container bg-neutral-96">
                                ...
                                <p></p>
                                <a
                                    href="https://careers.liveperson.com/?q=Sales&amp;source=campaignA&amp;gh_src="
                        ...
                        <div className="col">
                            <div className="comp-body-container bg-neutral-96">
                                ...
                                <p></p>
                                <a
                                    href="https://careers.liveperson.com/?q=customer%20success&amp;source=campaignA&amp;gh_src="
                                    className="link link-mt-small"
                                >
                                    See open roles
                                </a>
                        ...
                        <div className="col">
                            <div className="comp-body-container bg-neutral-96">
                                ...
                                <p></p>
                                <a
                                    href="https://careers.liveperson.com/?q=engineering&amp;source=campaignA&amp;gh_src="
                                    className="link link-mt-small"
                                >
                                    See open roles
                                </a>
                        ...
                        <div className="col">
                            <div className="comp-body-container bg-neutral-96">
                                ...
                                <p></p>
                                <a
                                    href="https://careers.liveperson.com/?q=data%20science%20%26%20ml&amp;source=campaignA&amp;gh_src="
                                    className="link link-mt-small"
                                >
                                    See open roles
                                </a>
                        ...
                        <div className="col">
                            <div className="comp-body-container bg-neutral-96">
                                ...
                                <p></p>
                                <a
                                    href="https://careers.liveperson.com/?q=design&amp;source=campaignA&amp;gh_src="
                                    className="link link-mt-small"
                                >
                                    See open roles
                                </a>
                        ...
                        <div className="col">
                            <div className="comp-body-container bg-neutral-96">
                                ...
                                <p></p>
                                <a
                                    href="https://careers.liveperson.com/?q=marketing%20%26%20comms&amp;source=campaignA&amp;gh_src="
                                    className="link link-mt-small"
                                >
                                    See open roles
                                </a>
                ...
                <div className="container">
                    <div className="row align-items-center justify-content-center">
                        <div className="col-lg-8">
                            ...
                            <p>
                                We’re an employee-choice company, meaning we
                                fully understand that every individual works
                                best in their own way whether it’s in an office,
                                remotely, or a hybrid. We celebrate different
                                voices because by empowering all, we fuel better
                                ideas. We’re looking for people who will
                                contribute meaningful, innovative work from
                                anywhere in the world — so come join our team.
                            </p>
                            <a className="link link-mt-small" href="/company/">
                                See our values
                            </a>
                            <div
                            ...
                            >
                                <div className="carousel-inner">
                                    <div className="carousel-item active">
                                        <img
                                            src="https://static.liveperson.com/static-assets/2022/02/08142544/6179997ca5036bd00a2e35d2_61789882c1c3fbfde655eae0_Image.png"
                                            className="d-block w-100"
                                            alt="Employee virual meeting"
                                        />
                                    </div>
                                    <div className="carousel-item">
                                        <img
                                            src="https://static.liveperson.com/static-assets/2022/02/08142545/617999999e2702beaf6f891f_617898ae88751c7e18f8aeb8_Carousel1.png"
                                            className="d-block w-100"
                                            alt="Employee pets"
                                        />
                                    </div>
                                    <div className="carousel-item">
                                        <img
                                            src="https://static.liveperson.com/static-assets/2022/02/08142546/617999b9e6f9bf7d172724fb_617898cbf7ece017a873b43d_Carousel3.png"
                                            className="d-block w-100"
                                            alt="Employees outside in London"
                                        />
                                    </div>
                                    <div className="carousel-item">
                                        <img
                                            src="https://static.liveperson.com/static-assets/2022/02/08142548/617999dca345b2b1ec6bcce9_617898e1a19f8b8c764e48da_Carousel4.png"
                                            className="d-block w-100"
                                            alt="Employees in office"
                                        />
                                    </div>
                                    <div className="carousel-item">
                                        <img
                                            src="https://static.liveperson.com/static-assets/2022/02/08142549/617999f72b28e197b654541d_617898f89b3d7f6e93647e0c_Carousel5.png"
                                            className="d-block w-100"
                                            alt="Employees socializing"
                                        />
                                    </div>
                                </div>
                                <button
