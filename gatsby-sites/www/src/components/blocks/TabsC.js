...
const TabsC = (props) => {
  ...
  return (
  <>
    <div autoapprove={props.autoApprove && "true"} id={props.anchor} className={`pane comp-tabs-c ${props.backgroundColor||"bg-transparent"} ${props.header ? 'pane-with-lead-text' : ''}`}>
