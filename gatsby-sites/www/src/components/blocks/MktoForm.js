...
const MktoForm = (props) => {
  ...
  return (
    <div autoapprove={props.autoApprove && "true"} className={`${props.cssClasses} pane pane-form ${props.sticky ? 'form--sticky' : ''} ${props.backgroundColor||"bg-rainbow"} ${props.header ? 'pane-with-lead-text' : ''}`} style={{display:'none'}}>
