...
const SideBySide = (props) => {
  ...
  return (
    <>
      <div data-localize={props.autoApprove && `auto-approve`} autoapprove={props.autoApprove && "true"} id={props.anchor} className={`pane comp-side-side ${props.backgroundColor||"bg-transparent"}`} autoapprove={props.autoApprove && "true"}>
