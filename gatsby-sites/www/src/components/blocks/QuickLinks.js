...
const QuickLinks = function(props) {
  ...
  return (
    <>
      <div data-localize={props.autoApprove && `auto-approve`} autoapprove={props.autoApprove && "true"} id={props.anchor} className={`pane comp-quick-links ${props.backgroundColor||"bg-transparent"}`}>
