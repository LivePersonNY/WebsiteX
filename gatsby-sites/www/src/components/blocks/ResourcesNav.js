...
const ResourceNav = function ({ active }) {
    ...
    return (
        <div className="pane pills-container text-center bg-neutral-96 py-4">
            <a href="/resources/" className={`btn pill mx-2 ${activeAll}`}>
                All Items
            </a>
            <a
            ...
            <a
                ...
                className={`btn pill mx-2 ${activeReports}`}
            >
                Guides and reports
            </a>
            <a
                href="/resources/news/"
                className={`btn pill mx-2 ${activeNews}`}
            >
                In the news
            </a>
            <a
                href="/resources/webinars/"
                className={`btn pill mx-2 ${activeWebinars}`}
            >
                Webinars
            </a>
            <a
