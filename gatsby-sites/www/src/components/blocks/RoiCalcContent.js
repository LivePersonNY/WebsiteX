        ...
        <div className="container">
            <div className="row align-items-center">
                <div className="col-lg-5 offset-lg-1">
                    ...
                    <br />This improvement in first contact resolution is driven primarily by the asynchronous aspect of messaging. In traditional voice contact centers, background noise, hang-ups, and long hold times all lead to consumers having to contact your brand again, repeating their same issue to a new agent. With messaging, the connection is continuous, with history always available in case a connection is lost. This history also provides useful context to agents, enabling them to better resolve consumers' inquiries. Not to mention, it limits the number of times customers have to repeat themselves — it’s a win-win!
                    </p>
                </div>
                <div className="col-lg-4 offset-lg-1">
                    <div className="graph-container">
