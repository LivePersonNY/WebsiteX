...
const Seo = ({ description, lang, meta, title, canonical, robots }) => {
  ...
  return (
    ...
    >
      ...
      <script id="gtmstart">{(function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
      new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],
      j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=false;j.src=
      'https://mktg-util.liveperson.com/tgs.js?id='+i+dl;f.parentNode.insertBefore(j,f);
      })(window,document,'script','dataLayer','GTM-K85P2PM')}</script>
